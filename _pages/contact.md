...
<nav class="navbar">
    <div class="navbar-container">
        ...
        <div class="nav-menu">
            ...
            <a href="{{ '/contact/' | relative_url }}" class="nav-link active">Contact</a>
        </div>
        <div class="hamburger">
            <span></span>
            <span></span>
...
<section class="contact-section">
    <div class="container">
        <h1>Get In Touch</h1>
        <p class="section-subtitle">Feel free to reach out to me with any questions or opportunities!</p>
        ...
        <div class="contact-content">
            <div class="contact-info">
                <div class="info-item">
                    ...
                    <div>
                        <h3>Email</h3>
                        <p><a href="mailto:rasulgusik@gmail.com">rasulgusik@gmail.com</a></p>
                    </div>
                </div>
                <div class="info-item">
                ...
                <div class="social-section">
                    ...
                    <div class="social-links-contact">
                        ...
                        <a href="https://www.codecademy.com/profiles/rhuseynli25808" target="_blank" class="social-icon-contact">
                            <i class="fab fa-code"></i> Codecademy
                        </a>
                    </div>
                </div>
            </div>
